...
<body>
    <div id="app">
        ...
        <div class="container-fluid vh-100">
            <div class="row h-100">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg_darkviolet navbar-dark sidebar collapse">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.projects.index' ? 'bg-secondary' : '' }}" href="{{route('admin.projects.index')}}">
                                    <i class="fa-solid fa-city"></i> Your travel
                                </a>
                            </li>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg_violet">
                    @yield('content')
                </main>
            </div>
        </div>
